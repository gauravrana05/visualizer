...
const Navbar = () => {
                      ...
                      >
                        ...
                        <div className="ml-4">
                          ...
                          <p className="mt-1 text-sm text-gray-500">
                            Get the maximum element in a 2D Grid of numbers.
                          </p>
                        </div>
                      </Link>
                      <Link
  ...
  */}
        ...
        <div
          className={
            open
              ? "opacity-100 scale-100 z-10 transition ease-out duration-200 absolute top-0 inset-x-0 p-2 transform origin-top-right md:hidden"
